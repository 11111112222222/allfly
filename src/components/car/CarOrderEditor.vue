    ...
    <section>
      <el-tabs type="border-card" v-model="activeTab" style="height:90%;overflow-y:auto;">
          ...
          <div class="tabContent">
            <div>
              ...
              <span style="margin-left:10px;">
                <el-radio v-model="peoRadio" label="自然人" @change="inputChange()">自然人</el-radio>
                <el-radio v-model="peoRadio" label="法人" @change="inputChange()">法人</el-radio>
              </span>
              <span style="margin:0 5px 0 20px;">性别</span>
              <el-select v-model="sexSel" size="mini" style="width:100px;" @change="inputChange()">
                <el-option v-for="item in sexOpt" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <span style="margin:0 5px 0 20px;">出生日期</span>
              <el-date-picker @change="inputChange()" size="mini" v-model="birthDate" type="date" placeholder="选择日期">
              </el-date-picker>
            </div>
            <div>
            ...
            <div class="msgContent">
              <div>
                ...
                <span style="margin:0 5px 0 20px;">出生日期</span>
                <el-date-picker size="mini" v-model="birthDate1" type="date" placeholder="选择日期">
                </el-date-picker>
              </div>
              <div>
                <div class="title">证件号码<span>*</span></div>
              ...
              <div>
                ...
                <el-select v-model="carSel" size="mini">
                  <el-option v-for="item in carOpt" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
              <fieldset>
                ...
                <div>
                  ...
                  <el-row :gutter="10">
                    ...
                    <el-col :span="6">
                      ...
                      <el-select v-model="carTypeSel" size="mini" style="width:120px;">
                        <el-option v-for="item in carTypeOpt" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                      </el-select>
                    </el-col>
                    <el-col :span="6">
                      <div style="padding:7px 0;">
                        <el-select v-model="typeSortSel" size="mini" style="width:100%;">
                          <el-option v-for="item in typeSortOpt" :key="item.value" :label="item.label"
                            :value="item.value">
                          </el-option>
                        </el-select>
                      </div>
                  ...
                  <el-row :gutter="10">
                    ...
                    <el-col :span="6">
                      ...
                      <el-date-picker size="mini" v-model="registerDate" type="date" placeholder="选择日期"
                        style="width:120px;">
                      </el-date-picker>
                    </el-col>
                    <el-col :span="6">
                  ...
                  <el-row :gutter="10">
                    ...
                    <el-col :span="6">
                      ...
                      <el-select v-model="insuranceSel" size="mini" style="width:120px;">
                        <el-option v-for="item in insuranceOpt" :key="item.value" :label="item.label"
                          :value="item.value">
                        </el-option>
                      </el-select>
                    </el-col>
                  ...
                  <el-row :gutter="10">
                    <el-col :span="6">
                      ...
                      <el-select v-model="judgeSel" size="mini" style="width:120px;">
                        <el-option v-for="item in judgeOpt" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                      </el-select>
                    </el-col>
                  </el-row>
            ...
            <div class="msgContent">
              <div>
                ...
                <el-select v-model="compSel" size="mini">
                  <el-option v-for="item in compOpt" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
              <div>
                <div class="title">起保日期<span>*</span></div>
                <el-date-picker size="mini" v-model="startDate" type="date" placeholder="选择日期">
                </el-date-picker>
              </div>
              <div>
              ...
              <div>
                ...
                <el-select v-model="orderTypeSel" size="mini">
                  <el-option v-for="item in orderTypeOpt" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              ...
              <div>
                ...
                <el-date-picker size="mini" v-model="outDate" type="date" placeholder="选择日期">
                </el-date-picker>
                <div class="title">&nbsp;&nbsp;交费日期<span>*</span></div>
                <el-date-picker size="mini" v-model="payDate" type="date" placeholder="选择日期">
                </el-date-picker>
                <div class="title">&nbsp;&nbsp;交费类别</div>
                <el-select v-model="payTypeSel" size="mini">
                  <el-option v-for="item in payTypeOpt" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
              <div>
                ...
                <el-select v-model="statusSel1" size="mini">
                  <el-option v-for="item in statusOpt1" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
                <div class="title">&nbsp;&nbsp;核发状态</div>
                <el-select v-model="statusSel2" size="mini">
                  <el-option v-for="item in statusOpt2" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
              <div>
                <div style="margin:10px 0 5px;">添加险种：</div>
                <el-table ref="recordTable" size="mini" border height="200px" :data="msgList" highlight-current-row>
                  <el-table-column type="index" width="50">
                  </el-table-column>
                  <el-table-column property="orderNum" label="险种简称" sortable :show-overflow-tooltip="true" width="120">
                  </el-table-column>
                  <el-table-column property="name" label="保费" sortable :show-overflow-tooltip="true" width="120">
                  </el-table-column>
                  <el-table-column property="address" label="费率（收）" sortable :show-overflow-tooltip="true" width="120">
                  </el-table-column>
                  <el-table-column property="address" label="费率（支）" sortable :show-overflow-tooltip="true" width="120">
                  </el-table-column>
                  <el-table-column property="address" label="保险期间起" sortable :show-overflow-tooltip="true" width="120">
                  </el-table-column>
                  <el-table-column property="address" label="保险期间止" sortable :show-overflow-tooltip="true" width="120">
                  </el-table-column>
                  <el-table-column label="操作">
                    <template slot-scope="scope">
                      <el-button @click.native.prevent="claimDelete(scope.$index,msgList)" type="danger" size="mini">移除
                      </el-button>
                      <el-button type="primary" size="mini" @click="dialogVisible = true">编辑</el-button>
                    </template>
                  </el-table-column>
                </el-table>
                <el-dialog title="险种编辑" :visible.sync="dialogVisible" width="50%">
                  <div class="bodyMsg">
                    <div>
                      <div>
                        <div class="carTitle">投保险种/代码</div>
                        <el-select v-model="insurNode" size="mini">
                          <el-option v-for="item in insurNodeOpt" :key="item.value" :label="item.label"
                            :value="item.value">
                          </el-option>
                        </el-select>
                      </div>
                      ...
                      <div>
                        ...
                        <el-date-picker size="mini" v-model="dialogStartDate" type="date" placeholder="选择日期">
                        </el-date-picker>
                      </div>
                      <div>
                        <div class="carTitle">保险期间止</div>
                        <el-date-picker size="mini" v-model="dialogEndDate" type="date" placeholder="选择日期">
                        </el-date-picker>
                      </div>
                    </div>
                    <fieldset>
            ...
            <div class="grid-content processBox">
              ...
              <el-input type="textarea" :rows="3" v-model="remark" size="mini" style="width:85%;" class="processInput">
              </el-input>
            </div>
          </div>
        </el-tab-pane>
        <el-tab-pane label="保单附件" name="relevanceTab">
          <div class="tabContent">
            <el-table class="table" ref="recordTable" size="mini" border height="780px" :data="msgList"
              highlight-current-row>
              <el-table-column type="index" width="50">
              </el-table-column>
              <el-table-column property="orderNum" label="类别" sortable :show-overflow-tooltip="true" width="110">
              </el-table-column>
              <el-table-column property="name" label="记录属性" sortable :show-overflow-tooltip="true">
              </el-table-column>
              <el-table-column property="address" label="属性内容" sortable :show-overflow-tooltip="true" width="100">
              </el-table-column>
              <el-table-column property="orderNum" label="有效期起" sortable :show-overflow-tooltip="true" width="100">
              </el-table-column>
              <el-table-column property="name" label="有效期止" sortable :show-overflow-tooltip="true" width="100">
              </el-table-column>
              <el-table-column property="address" label="附件说明" sortable :show-overflow-tooltip="true" width="100">
              </el-table-column>
              <el-table-column property="name" label="附件格式" sortable :show-overflow-tooltip="true" width="100">
              </el-table-column>
              <el-table-column property="address" label="大小(KB)" sortable :show-overflow-tooltip="true" width="100">
              </el-table-column>
            ...
            <el-dialog title="车险保单记录附件" :visible.sync="fileDialogVisible" width="60%">
              <div class="bodyMsg">
                <div>
                  ...
                  <el-select v-model="recordProperty2" size="mini">
                    <el-option v-for="item in propertyOpt2" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </div>
                <div>
                ...
                <div>
                  ...
                  <el-date-picker size="mini" v-model="effectiveDate" type="daterange" range-separator="至"
                ...
                <div>
                  <div class="grid-content processBox">
                    ...
                    <el-input type="textarea" :rows="3" v-model="fileRemark" size="mini" class="processInput">
                    </el-input>
                  </div>
                </div>
                <div>
                  <div class="grid-content processBox">
                    ...
                    <el-upload class="upload-demo processInput" action="https://jsonplaceholder.typicode.com/posts/"
                      :before-remove="beforeRemove" :on-change="handleChange" multiple :limit="1"
        ...
        <el-tab-pane label="理赔" name="friendTab">
          <div class="tabContent">
            <el-table class="table" ref="recordTable" size="mini" border height="780px" :data="msgList"
              ...
              <el-table-column property="name" label="报案号" sortable :show-overflow-tooltip="true" width="120">
              </el-table-column>
              <el-table-column property="orderNum" label="理赔保单号" sortable :show-overflow-tooltip="true" width="120">
              </el-table-column>
              <el-table-column property="name" label="报案时间" sortable :show-overflow-tooltip="true" width="120">
              </el-table-column>
              <el-table-column property="address" label="查勘员" sortable :show-overflow-tooltip="true" width="120">
              </el-table-column>
              <el-table-column property="name" label="是否结案" sortable :show-overflow-tooltip="true" width="120">
              </el-table-column>
              <el-table-column property="orderNum" label="备注" sortable :show-overflow-tooltip="true">
              </el-table-column>
              <el-table-column label="操作" width="160">
                <template slot-scope="scope">
                  <el-button @click.native.prevent="claimDelete(scope.$index,msgList)" type="danger" size="mini">移除
  ...
  export default {
    ...
    addNewCarOrder() {
      this.$axios.post('', {
          policyNo: '',
          carClientVO: {
            certfId: this.cardValue,
            name: this.clientName,
            lawIdentity: this.peoRadio,
            certfType: this.cardSel,
            birthday: this.birthDate,
            sex: this.sexSel,
            telephone: this.phoneNum,
            addressType: this.addressSel,
            contactAddress: this.addressValue,
            code: this.emailValue
          },
          carInsuredVO: {
            carClientVO: {
              certfId: this.cardValue1,
              name: this.clientName1,
              lawIdentity: this.peoRadio1,
              certfType: this.cardSel1,
              birthday: this.birthDate1,
              sex: this.sexSel1,
              telephone: this.phoneNum1,
              addressType: this.addressSel1,
              contactAddress: this.addressValue1,
              code: this.emailValue1
            },
            carBasicInfo: {
              licensePlateNo: this.carNum,
              brandModel: this.brandType,
              engineNo: this.engineNum,
              frameNo: this.frameNum,
              vehicleType: this.carTypeSel,
              vehicleModel: this.typeSortSel,
              seatNumber: this.tonnage,
              tonNumber: this.tonnage,
              vehicleDisplacement: this.paiLiang,
              power: this.power,
              registrationDate: this.registerDate,
              averageMiles: this.mileage,
              ownerName: this.ownerName,
              carInsurMessage: this.insuranceSel,
              carPrice: this.carPrice,
              accidentNumber: this.outTime,
              isImport: this.judgeSel
            }
          },
          contractorList: [],
          carInsuranceTypeList: [{
              carInsurId: this.trafficNum|this.businessNum,
              insurCompanyName:this.compSel,
              insurTypeName:'',
              insurAmount:''
            }]
        })
