 ...
 <div class="page">
    ...
    <fieldset>
        ...
        <ul>
          ...
          <li><el-radio :label="'fanchou'" class="elradio">承揽人</el-radio>
          <el-input v-model="input" :disabled="fcDisabled2" size="mini" placeholder="请输入内容" style="width:200px;margin-left: 10px;"></el-input>
...
export default {
 ...
 methods:{
   ...
   handleSelectChange(value){
    ...
    linkToOrderData(){
      this.$router.push({path:"/user/nocarNewOrderData",query:{findOrderItem:this.findOrderItem}})
    },
    onSubmit() {
        console.log('submit!');
    },
