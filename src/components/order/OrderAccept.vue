    ...
    <el-tabs type="border-card">
      <el-tab-pane label="查询">
        <div class="row company">
          ...
          <el-select size="mini" v-model="companyTypeSel" placeholder="请选择">
            <el-option v-for="item in companyTypeOpt" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
          <el-select size="mini" v-model="companySel" placeholder="请选择" multiple collapse-tags>
        ...
        <div class="row policyNumber">
          ...
          <el-input size="mini" style="width:20%" placeholder="请输入内容" v-model="numberVal" clearable>
          </el-input>
        </div>
        <div class="row policyStatus">
          ...
          <el-select size="mini" v-model="statusSel" placeholder="请选择">
        ...
        <div class="row dateIndex">
          ...
          <el-select size="mini" v-model="dateSel" placeholder="请选择">
            <el-option v-for="item in dateOpt" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
          <el-date-picker size="mini" v-model="IndexDate" type="daterange" align="right" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="datepickerOpt">
          </el-date-picker>
        </div>
        <div class="row policyReceipt">
          ...
          <el-select size="mini" v-model="receiptSel" placeholder="请选择">
            <el-option v-for="item in receiptOpt" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
          <el-date-picker size="mini" v-model="receiptDate" type="daterange" align="right" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="receiptPickerOpt">
          </el-date-picker>
        </div>
        ...
        <fieldset>
          ...
          <div class="wrapper">
            <div class="row property">
              ...
              <el-select size="mini" v-model="propertySel" placeholder="请选择" style="width:8%;marginRight:2px">
              ...
              <el-select size="mini" v-model="IndexDate" placeholder="请选择" style="width:10%">
                <el-option v-for="item in propertyExiOpt" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <el-input size="mini" style="width:20%" placeholder="请输入内容" v-model="propertyVal" clearable>
              </el-input>
            </div>
            <div class="row propertyRele">
              ...
              <el-select size="mini" v-model="validityTimeSel" placeholder="请选择" style="width:15%;">
            ...
            <div class="row insuranceType">
              ...
              <el-select size="mini" v-model="insuTypeSel" placeholder="请选择">
            ...
            <div class="row bracket">
              ...
              <el-select size="mini" v-model="bracketSel" placeholder="请选择" style="width:9%;marginRight:2px">
                <el-option v-for="item in bracketOpt" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <el-input-number size="mini" v-model="bracketLowVal" controls-position="right" :min="1" :max="10" style="width:8%;marginRight:2px"></el-input-number>至
              <el-input-number size="mini" v-model="bracketHigVal" controls-position="right" :min="1" :max="10" style="width:8%;"></el-input-number>
            </div>
            <div class="row accpeter">
              ...
              <el-select size="mini" v-model="accpeterSel" placeholder="请选择" style="width:8%;marginRight:2px">
                <el-option v-for="item in accpeterOpt" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <el-select size="mini" v-model="accpeterNameSel" placeholder="请选择" style="width:9%">
                <el-option v-for="item in accpeterNameOpt" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <el-input size="mini" style="width:20%" placeholder="请输入内容" v-model="accpeterVal" clearable>
              </el-input>
            </div>
            <div class="row staff">
              <div class="title">
              ...
              <el-select size="mini" v-model="staffSel" placeholder="请选择">
                <el-option v-for="item in staffOpt" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <el-input size="mini" style="width:20%" placeholder="请输入内容" v-model="staffVal" clearable>
              </el-input>
            </div>
          </div>
        </fieldset>
