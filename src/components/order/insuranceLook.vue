              ...
              <table border="1">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <span>保单受益人：</span>
                    <div
                      id="insuranceBenefitMan"
                      @click="insurancePeopleMessage"
                    >{{name1}}&nbsp;&nbsp;{{ID1}}</div>
                    <span>本人</span>
                  </td>
                </tr>
                ...
                <template slot-scope="scope">
                  <div v-if="item.operate">
                    ...
                    <el-button
                      type="primary"
                      size="small"
                      @click="editInformation2(scope.row)"
                    >查看/编辑</el-button>
                  </div>
                ...
                <template slot-scope="scope">
                  <div v-if="item.operate">
                    ...
                    <el-button
                      type="primary"
                      size="small"
                      @click="editInformation1(scope.row)"
                    >查看/编辑</el-button>
                  </div>
                  <div v-else>{{ scope.row[item.property]}}</div>
                </template>
              ...
              <el-table-column label="存在关系" width="180">
                <template slot-scope="scope">
                  ...
                  <el-select v-model="scope.row.relationSelected" placeholder="请选择">
                    <el-option
                      v-for="item in scope.row.relations"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value"
                    ></el-option>
              ...
              <div class="grid-content">
                <div>
                  <span
                    ...
                    @click="personDetail"
                  >季书影[420881201712051043]</span> 投保时年龄：0岁
                </div>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="14">
              <div class="grid-content">
                ...
                <el-select
                  v-model="insuranceMoneyTypeSelected"
                  placeholder="请选择"
                  style="width:90px;"
                >
                  <el-option
                    v-for="item in insuranceMoneyType"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
        ...
        <el-form :model="form2">
          ...
          <el-form-item label="记录属性" :label-width="formLabelWidth">
            <el-select v-model="form2.attr1Selected" placeholder="">
              <el-option v-for="item in form2.attr1" :label="item.label" :value="item.value" :key="item.value"></el-option>
            </el-select>
            <el-select v-model="form2.attr2Selected" placeholder="">
              <el-option v-for="item in form2.attr2" :label="item.label" :value="item.value" :key="item.value"></el-option>
            </el-select>
          </el-form-item>
...
export default {
  data() {
    return {
      ...
      tableHead1: [
        { label: "客户姓名", property: "name", width: "100", fixed: false },
        { label: "证件号码", property: "number", width: "180", fixed: false },
        {
          label: "受益型态",
      ...
      total: "5",
      tableHead3: [
        { label: "险种代码", property: "number", width: "180", fixed: false },
        { label: "受理日期", property: "dealDate", width: "180", fixed: false },
        {
          label: "生效日期",
          property: "effectDate",
          width: "180",
      ...
      tableHead4: [
        { label: "类别", property: "type", width: "180", fixed: false },
        {
          label: "记录属性",
