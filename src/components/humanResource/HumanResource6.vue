  ...
  <div class="page">
    ...
    <div class="yeJiContent">
      <div class="tabSecondContent">
        ...
        <div class="content">
          分支机构&nbsp;<el-select v-model="branchSelectValue" placeholder="请选择" size="mini" style="width:200px">
            <el-option v-for="item in branchOpt" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
          &nbsp;&nbsp;人员&nbsp;<el-input v-model="checkObject" size="mini" placeholder="请输入内容" style="width:300px;">
          </el-input>
      ...
      <div class="tabSecondContent">
        ...
        <div class="content">
          <el-select v-model="bossSelectValue" placeholder="请选择" size="mini" style="width:200px">
            <el-option v-for="item in bossSelecOptions" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
      ...
      <div class="tabSecondContent">
        ...
        <div class="content">
          <el-date-picker style="width:200px" size="mini" v-model="checkMonth" type="month" placeholder="选择月">
          </el-date-picker>
        </div>
      </div>
      <div class="tabSecondContent">
    ...
    <el-row :gutter="20">
      <el-col :span="18">
        <el-table size="mini" :data="recordList1" border fit style="width: 100%">
          <el-table-column v-for="item in tableHead1" :key="item.property" :label="item.label" :property="item.property"
            :fixed="item.fixed" :width="item.width" :show-overflow-tooltip="true">
        ...
        <el-dialog title="人事组织结构详细信息" :visible.sync="personalDetailDailog">
          <p>陈娟的详细信息</p>
          <el-table size="mini" :data="recordList2" border fit style="width: 100%">
            <el-table-column v-for="item in tableHead2" :key="item.property" :label="item.label"
              :property="item.property" :fixed="item.fixed" :width="item.width" :show-overflow-tooltip="true">
              <template slot-scope="scope">
                <div v-if="item.oper">
                  <el-button type="primary" size="small" @click="editInformation(scope.row)">查看/编辑</el-button>
                </div>
