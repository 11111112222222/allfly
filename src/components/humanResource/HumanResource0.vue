            ...
            <div class="tabContent">
                ...
                <fieldset>
                    ...
                    <div class="content">
                        ...
                        <el-select
                            size="mini"
                            v-model="informationSel"
                            multiple
                            collapse-tags
                            >
                            <el-option
                            v-for="item in informationOpt"
                            :key="item.value"
                            :value="item.value">
                            </el-option>
                        </el-select>
                        ...
                        <div class="secondcontent">
                            <div class="secondcontent1">
                                ...
                                <div class="select2">
                                    <el-select
                                        size="mini"
                                        v-model="isAccountSel"
                                        multiple
                                        collapse-tags
                                        >
                                        <el-option
                                        v-for="item in isAccountOpt"
                                        :key="item.value"
                                        :value="item.value">
                                        </el-option>
                                    </el-select>
                            ...
                            <div class="secondcontent2">
                                <el-checkbox v-model="bankChecked" class="checkbox"></el-checkbox>
                                <el-select
                                    size="mini"
                                    v-model="bankSel"
                                    multiple
                        ...
                        <div class="secondcontent">
                            <div class="thirdcontent">
                                <div class="select1">
                                    <el-select
                                    size="mini"
                                    v-model="workStatusSel"
                                    multiple
                                    collapse-tags
                                    style="width:100%"
                                    >
                                    <el-option
                                    v-for="item in workStatusOpt"
                                    :key="item.value"
                                    :value="item.value">
                                    </el-option>
                                   </el-select>
                            ...
                            <div class="thirdcontent1">
                                <div>
                                    <el-checkbox v-model="enterCompanyChecked" class="checkbox"></el-checkbox>
                                    入司日期：
                                    <el-date-picker
                                    size="mini"
                                    v-model="enterCompanytime"
                                    type="daterange"
                                    range-separator="至"
                                    start-placeholder="开始日期"
                                    end-placeholder="结束日期">
                                ...
                                <div>
                                    <el-checkbox v-model="workCodeChecked" class="checkbox"></el-checkbox>
                                    在职编码：
                                    <el-input
                                        size="mini"
                                        placeholder="请输入联系电话"
                                        v-model="workCodeinput"
                                        class="inputNum"
                                        clearable>
                                    </el-input>
                                </div>
                                <div>
                                   <el-checkbox v-model="jobEffictiveChecked" class="checkbox"></el-checkbox>
                                   职级生效日期： 
                                   <el-date-picker
                                    size="mini"
                                    v-model="jobEffictiveTime"
                                    type="daterange"
                                    range-separator="至"
                                    start-placeholder="开始日期"
                                    end-placeholder="结束日期">
