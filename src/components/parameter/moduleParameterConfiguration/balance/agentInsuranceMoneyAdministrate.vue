            ...
            <div>
              ...
              <div class="content">
                ...
                <el-select size="mini" v-model="compSort">
                  <el-option v-for="item in sortOpt" :key="item.value" :value="item.value"></el-option>
                </el-select>&nbsp;&nbsp;
                <el-select
                  size="mini"
                  v-model="compSel"
                ...
                >
                  <el-option v-for="item in compOpt" :key="item.value" :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div class="content">
                ...
                <el-select size="mini" v-model="stopSort">
                  <el-option v-for="item in stopOpt" :key="item.value" :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            <div>
              ...
              <div class="content">
                ...
                <el-select size="mini" v-model="zfSort">
                  <el-option v-for="item in zfOpt" :key="item.value" :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            <div>
              ...
              <div class="content">
                ...
                <el-select size="mini" v-model="paramSort">
                  <el-option v-for="item in paramOpt" :key="item.value" :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            <div>
        ...
        <div class="tabContent">
          <div class="listTable">
            ...
            >
              ...
              <el-table-column property="orderNum" label="保单号码" sortable width="120"></el-table-column>
              <el-table-column property="name" label="姓名" sortable width="120"></el-table-column>
              <el-table-column property="address" label="地址" sortable></el-table-column>
            </el-table>
          </div>
          <div class="oprateBtn">
            ...
            <el-button type="primary" size="mini" @click="newAdd">新增一笔</el-button>
          </div>
        </div>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  methods: {
    ...
    queryEdit() {
      this.$router.push({ path: "/user/insuranceInfoEdit" });
    },
    delateInfo() {
    ...
    newAdd() {
      console.log("进来过了");
      this.$router.push({ path: "/user/insuranceInfoAdd" });
    }
  },
  //  watch: {
  //      '$route':"checked"
